...
CKEDITOR.plugins.add( 'simplebox', {
	...
	init: function( editor ) {
		...
		editor.widgets.add( 'simplebox', {
			...
			allowedContent:
				'div(!simplebox,align-left,align-right,align-center){tangyIf};' +
			...
			// When a widget is being initialized, we need to read the data ("align" and "tangyIf")
